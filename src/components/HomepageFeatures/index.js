    ...
    description: (
      <>
        <div className="hero-container">
          ...
          <p>
            Singularité est un forum dystopique, fantastique et futuriste, dans un univers de notre conception à l’ambiance éclectique, entre fantastique et horreur.
            <br />
          ...
          <ul>
            ...
            <li>
              ...
              jamais basculer dans les excès, le grotesque ou l’explicite.
            </li>
          </ul>
          <p>
            Singularité s’adresse idéalement à des rôlistes qui ont envie de s’impliquer dans l’intrigue principale et qui n’ont pas peur des surprises
            narratives. Mais libre à vous de nous rejoindre pour le plaisir d’écrire les scènes plus tranquilles que cet univers permet !
          </p>
        </div>
      </>
    )
